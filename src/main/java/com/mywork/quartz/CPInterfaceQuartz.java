...
import com.mywork.model.JxsscJsonBean;
...
public class CPInterfaceQuartz {
	...
	public void execute(){
		...
		try {
	        ...
	        while ((lines = reader.readLine()) != null) {
	        	jxssc = JSON.parseObject(lines, JxsscJsonBean.class);
	...
	public static void main(String[] args) {
		...
		JxsscJsonBean jxssc = JSON.parseObject(ss, JxsscJsonBean.class);
		String qhStr = jxssc.getData().get(0).getExpect();
    	String code = jxssc.getData().get(0).getOpencode();
